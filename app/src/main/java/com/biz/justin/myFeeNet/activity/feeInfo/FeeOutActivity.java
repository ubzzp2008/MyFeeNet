...
@ContentView(value = R.layout.fee_out_layout)
public class FeeOutActivity extends BaseActivity {
    @ViewInject(R.id.fee_out_count)
    private TextView feeOutCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeTopText(this.getString(R.string.home_fee_out));
...
//                    feePayBottom.setVisibility(View.VISIBLE);
//                } else {
//                    listItemAdapter = new MyListViewAdapter(feeList, getApplicationContext(), false);
//                    listItem.setAdapter(listItemAdapter);
//                    feePayBottom.setVisibility(View.GONE);
//                }
//            }
//        });
        getFeePayInfos();
    ...
    private void getFeePayInfos() {
        proDialog = ProgressDialog.show(this, null,
                "数据加载中....", true, true);
        FeeInfo feeInfo = new FeeInfo();
        feeInfo.setFeeType(StaticParams.FEE_TYPE_OUT);
    ...
    private void callRemoteFeeInfoList(String url, String jsonParam) {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (json.isSuccess()) {
                    String str = String.format(FeeOutActivity.this.getString(R.string.fee_count), Double.parseDouble(json.getMsg()));
                    feeOutCount.setText(str);
                    List<FeeInfo> datas = JSONArray.parseArray(json.getObj(), FeeInfo.class);
                    listItem.setAdapter(new CommonAdapter<FeeInfo>(FeeOutActivity.this, datas, R.layout.fee_list_item) {
                        @Override
    ...
    /*@Event(value = R.id.list_pay, type = AdapterView.OnItemLongClickListener.class)
    private boolean listItemOnLongClick(AdapterView<MyListViewAdapter> adapterView, final View view, final int position, long l) {
        ...
        updateMoney.setText(-1 * feeInfo.getMoney() + "");
    ...
    /*@Event(value = R.id.list_pay, type = AdapterView.OnItemClickListener.class)
  ...
  /*  //全选、反选、删除按钮绑定点击事件
    @Event(value = {R.id.fee_list_pay_delete, R.id.fee_list_pay_select_all,
            R.id.fee_list_pay_select_back}, type = View.OnClickListener.class)
    private void bottonButOnClick(View view) {
        switch (view.getId()) {
            //删除按钮点击
            case R.id.fee_list_pay_delete:
                deleteData();
                break;
            //全选按钮点击
            case R.id.fee_list_pay_select_all:
                ...
                break;
            //反选按钮点击
            case R.id.fee_list_pay_select_back:
...
/*
    ...
    @Event(value = R.id.filterBtn, type = View.OnClickListener.class)
    private void filterBtnOnClick(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
